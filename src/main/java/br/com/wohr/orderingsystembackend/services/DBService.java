...
import br.com.wohr.orderingsystembackend.domain.*;
...
import br.com.wohr.orderingsystembackend.repositories.*;
...
public class DBService {
    ...
    @Autowired
    CateroriaRepository categoriaRepository;
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        cat1.getProdutos().addAll(Arrays.asList(p1, p2, p3, p12, p13, p14, p15, p16, p17, p18,
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "willianbmohr@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, passwordEncoder.encode("123456"));
        Cliente cli2 = new Cliente(null, "Willian Mohr", "willianbmohr@hotmail.com", "45390201027", TipoCliente.PESSOAFISICA, passwordEncoder.encode("123456"));
        cli2.addPerfil(Perfil.ADMIN);

        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
        cli2.getTelefones().addAll(Arrays.asList("27363332", "93838339"));

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Pedro Taquis", "110", null, "Centro", "38777013", cli2, c2);
