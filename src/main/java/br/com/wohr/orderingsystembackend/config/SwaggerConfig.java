...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.wohr.orderingsystembackend.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Esta API é utilizada a documenteação do projeto",
                "Versão 1.0",
                "",
                new Contact("Willian Mohr", "https://www.linkedin.com/in/willian-mohr-69691912a/", "willianbmohr@gmail.com"),
                "Permitido somente para testes",
                "",
